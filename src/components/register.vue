    ...
    <section id="login-content">
      <div class="login-centre">
        <div class="login-switch clearfix">
          <p class="fr">我已经注册，现在就 <router-link to="/Login">登录</router-link></p>
        </div>
          ...
          <div class="H-over">
            <form>
              ...
              <div class="login-input">
                ...
                <input type="text" class="list-input1" id="email" name="info[username]" placeholder="">
              </div>
              <div class="login-input">
              ...
              <div class="item-ifo">
                ...
                <label for="protocol">我已阅读并同意<a id="protocol" class="blue" href="#">《插画网站用户协议》</a></label>
                <span class="clr"></span>
              </div>
